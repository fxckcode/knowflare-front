  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent className="max-w-[300px]">
        ...
        <DropdownMenuItem onClick={() => setModel("gemini-2.5-pro")}>
          <div className="flex items-center gap-3">
            <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 64 64" fill="none" className="size-5"><g clip-path="url(#a)"><path fill="url(#b)" d="M32 64A38.14 38.14 0 0 0 0 32 38.14 38.14 0 0 0 32 0a38.15 38.15 0 0 0 32 32 38.15 38.15 0 0 0-32 32"></path></g><defs><linearGradient id="b" x1="0" x2="4398.72" y1="6400" y2="1945.28" gradientUnits="userSpaceOnUse"><stop stop-color="#1C7DFF"></stop><stop offset="0.52" stop-color="#1C69FF"></stop><stop offset="1" stop-color="#F0DCD6"></stop></linearGradient><clipPath id="a"><path fill="#fff" d="M0 0h64v64H0z"></path></clipPath></defs></svg>
            <div className="flex flex-col gap-0">
              <span className="text-sm">Gemini 2.5 Pro</span>
              <span className="text-muted-foreground line-clamp-2 text-xs">Advanced reasoning, coding, and multimodal understanding.</span>
            </div>  
          </div>
        </DropdownMenuItem>
      </DropdownMenuContent>
